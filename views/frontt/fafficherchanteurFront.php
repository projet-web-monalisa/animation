            ...
            <div class="search__area">
                <div class="container" >
                    <div class="row" >
                        ...
                        <form method="POST" action="recherchechanteur.php">
...
<div >
        ...
        <div class="slider__container slider--one">
            <div class="slider__activation__wrap owl-carousel owl-theme">
                <!-- Start Single Slide -->
                <div class="slide slider__full--screen" style="background: rgba(0, 0, 0, 0) url(img/9.png) no-repeat scroll center center / cover ;">
